...
<style>
	...
	.collapsed .brand-text,.collapsed .nav-label,.collapsed .nav-group h2,.collapsed .sidebar-status div { display:none; }.collapsed .sidebar-brand { padding:0; justify-content:center; }.collapsed .collapse-toggle { position:absolute; top:52px; right:5px; width:21px; height:21px; border-radius:50%; background:var(--ui-surface-2); }.collapsed .nav-group { padding-top:.55rem; border-top:1px solid var(--ui-border-subtle); }.collapsed .nav-item { justify-content:center; padding:.5rem; }.collapsed .nav-icon :global(svg) { width:20px; height:20px; }.collapsed .sidebar-status { justify-content:center; padding:.7rem .4rem; }
	...
	@media (max-width:1100px) { .sidebar { width:72px; }.sidebar .brand-text,.sidebar .nav-label,.sidebar .nav-group h2,.sidebar .sidebar-status div { display:none; }.sidebar .sidebar-brand { padding:0; justify-content:center; }.sidebar .collapse-toggle { display:none; }.sidebar .nav-group { padding-top:.55rem; border-top:1px solid var(--ui-border-subtle); }.sidebar .nav-item { justify-content:center; padding:.5rem; }.sidebar .sidebar-status { justify-content:center; padding:.7rem .4rem; } }
